...
from model.BiT.resnet import *
from model.BiT.help_funcs import Transformer, TransformerDecoder, TwoLayerConv2d
...
if __name__ == '__main__':
    ...
    model = BASE_Transformer(input_nc=3, output_nc=1, token_len=4, resnet_stages_num=4,
                             with_pos='learned', enc_depth=1, dec_depth=8, dim_head=64, decoder_dim_head=64).cuda()
