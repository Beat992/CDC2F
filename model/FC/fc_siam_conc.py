...
class Siam_conc(nn.Module):
    """SiamUnet_conc segmentation network."""

    def __init__(self, in_channel, out_channel):
        super(Siam_conc, self).__init__()

        self.conv11 = nn.Conv2d(in_channel, 16, kernel_size=3, padding=1)
        ...
        # self.conv11d = nn.Conv2d(16, out_channel, kernel_size=1, padding='same')
        self.conv11d = nn.ConvTranspose2d(16, out_channel, kernel_size=3, padding=1)
